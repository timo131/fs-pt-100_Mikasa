...
def seed_info():
        ...
        # Crear 5 usuarios
        users = [
            User(user_name="juan", hogar_id=0, email="juan@mail.com", password=generate_password_hash("juan123"), avatar_url="https://images.pexels.com/photos/3785079/pexels-photo-3785079.jpeg", admin=True, favorito_recetas={}, favorito_peliculas={}),
            User(user_name="ana", hogar_id=0, email="ana@mail.com", password=generate_password_hash("ana123"), avatar_url="https://images.pexels.com/photos/3763188/pexels-photo-3763188.jpeg", admin=False, favorito_recetas={}, favorito_peliculas={}),
            User(user_name="pedro", hogar_id=0, email="pedro@mail.com", password=generate_password_hash("pedro123"), avatar_url="https://images.pexels.com/photos/31517042/pexels-photo-31517042.jpeg", admin=False, favorito_recetas={}, favorito_peliculas={}),
            User(user_name="maria", hogar_id=1, email="maria@mail.com", password=generate_password_hash("maria123"), avatar_url="https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg", admin=True, favorito_recetas={}, favorito_peliculas={}),
            User(user_name="lucia", hogar_id=1, email="lucia@mail.com", password=generate_password_hash("lucia123"), avatar_url="https://images.pexels.com/photos/6706847/pexels-photo-6706847.jpeg", admin=True, favorito_recetas={}, favorito_peliculas={}),
        ]
