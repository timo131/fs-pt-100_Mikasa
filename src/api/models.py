...
class User(db.Model):
    ...
    tareas = relationship("Tareas", back_populates="user", foreign_keys="Tareas.user_id")
    tareas_done_by = relationship("Tareas", back_populates="done_by_user", foreign_keys="Tareas.done_by")
...
class User_pagos (db.Model):
    ...
    user_id: Mapped[int]= mapped_column(ForeignKey ("user.id"))
    hogar_id: Mapped[int]= mapped_column(ForeignKey ("hogar.id"))
    pagos_id: Mapped[int]= mapped_column(ForeignKey("pagos.id"))
